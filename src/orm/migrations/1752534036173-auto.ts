...
export class Auto1752534036173 implements MigrationInterface {
    name = 'Auto1752534036173'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "comment" ADD CONSTRAINT "FK_27ce1f8f32138a1a68bd92cff7d" FOREIGN KEY ("user_uuid") REFERENCES "user"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
